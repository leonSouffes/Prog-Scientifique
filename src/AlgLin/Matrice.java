...
public class Matrice {
    ...
    public void recopie(Matrice arecopier) {
        int ligne = arecopier.nbLigne();
        int colonne = arecopier.nbColonne();
        this.coefficient = new double[ligne][colonne];
        for (int i = 0; i < ligne; i++) {
            if (colonne >= 0) {
                System.arraycopy(arecopier.coefficient[i], 0, this.coefficient[i], 0, colonne);
            }
        }
    }
    ...
    public static Matrice verif_addition(Matrice a, Matrice b) throws Exception {
    ...
    public static Matrice verif_produit(Matrice a, Matrice b) throws Exception {
        int ligne;
        int colonne;
